...
These models represent a small but meaningful step toward a larger mission: 

help any under-resourced language build high-quality, openly available TTS voices using only community data and ethical voice-cloning techniques.
...
Large tech companies rarely prioritise minority languages; the commercial incentive isn’t there. For speakers of Asturian or Aragonese, who can also use Spanish, this lack of support nudges people away from their own languages. Over time, that invisibility contributes to language shift and erosion.

As a non-profit, our priorities are different: we treat language as accessibility, and we want modern voice technology to be something everyone can use.
...
### Why This Matters — A Short Reality Check
...
For speakers of Asturian or Aragonese, who can also use Spanish, there’s little commercial upside. That lack of support has real consequences: when you can’t use your own language with mainstream voice technology, you’re nudged toward the “prestigious” language that is supported. Over time, that accelerates language shift and erosion.
...
* With our brand-new, high-quality, single-speaker dataset, we could finally train our TTS model. 
...
[Asturian — dii (female)](https://huggingface.co/OpenVoiceOS/phoonnx_ast_dii_unicode)

<audio controls>
  <source src="/assets/blog/an/dii_ast.wav" type="audio/wav">
  Your browser does not support the audio element.
</audio>

[Asturian — miro (male)](https://huggingface.co/OpenVoiceOS/phoonnx_ast_miro_unicode)
...
[Aragonese — dii (female)](https://huggingface.co/OpenVoiceOS/phoonnx_an_dii_unicode)

<audio controls>
  <source src="/assets/blog/an/dii_an.wav" type="audio/wav">
  Your browser does not support the audio element.
</audio>

[Aragonese — miro (male)](https://huggingface.co/OpenVoiceOS/phoonnx_an_miro_unicode)
