...
🔗 [https://github.com/OpenVoiceOS/ovos-stt-plugin-whispercpp](https://github.com/OpenVoiceOS/ovos-stt-plugin-whispercpp)
...
| **RNN-T (Transducer)** | sequence-to-sequence models that do not employ attention mechanisms. | [Arxiv](https://arxiv.org/abs/1211.3711)                                                               |
...
This plugin connects OVOS with the [**Sherpa-ONNX ecosystem**](https://github.com/k2-fsa/sherpa-onnx), a performant, multi-model, ONNX-centric ASR framework.
...
This plugin integrates the [**onnx-asr Python library**](https://github.com/istupakov/onnx-asr) directly into OVOS, giving you a simple API to run ONNX models.
