---
title: "End-to-End Skill Testing with OvoScope"
excerpt: "OvoScope runs a full OVOS pipeline in-process, with no server, no audio stack and no network. It ships on PyPI as a pytest plugin and underpins the end-to-end test sweep across the default skills. Here is how the framework works and what it verifies."
