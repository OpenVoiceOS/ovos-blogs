...
The package ships **617 message-type models**, listed in full in the [repository's README](https://github.com/OpenVoiceOS/ovos-pydantic-models#readme), organized by the subsystem that owns them:
