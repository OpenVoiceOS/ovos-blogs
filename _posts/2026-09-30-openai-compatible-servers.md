...
excerpt: "The OVOS speech servers speak OpenAI (and MaryTTS). Keep your existing code, swap the base URL, and run speech-to-text, text-to-speech, and chat locally and private."
...
| `ovos-stt-http-server` (repository `ovos-stt-server`) | OpenAI `audio.transcriptions` (and `audio.translations`) | [#77](https://github.com/OpenVoiceOS/ovos-stt-server/pull/77) |
...
- Deepgram ([#54](https://github.com/OpenVoiceOS/ovos-stt-http-server/pull/54))
- Google ([#55](https://github.com/OpenVoiceOS/ovos-stt-http-server/pull/55))
- AssemblyAI ([#56](https://github.com/OpenVoiceOS/ovos-stt-http-server/pull/56))
- Speechmatics ([#57](https://github.com/OpenVoiceOS/ovos-stt-http-server/pull/57))
- Azure ([#58](https://github.com/OpenVoiceOS/ovos-stt-http-server/pull/58))
- AWS Transcribe ([#60](https://github.com/OpenVoiceOS/ovos-stt-http-server/pull/60))
- IBM Watson ([#61](https://github.com/OpenVoiceOS/ovos-stt-http-server/pull/61))
- Wit.ai ([#62](https://github.com/OpenVoiceOS/ovos-stt-http-server/pull/62))
- Vosk ([#63](https://github.com/OpenVoiceOS/ovos-stt-http-server/pull/63))
- whisper.cpp ([#64](https://github.com/OpenVoiceOS/ovos-stt-http-server/pull/64))
- and Kaldi ([#69](https://github.com/OpenVoiceOS/ovos-stt-http-server/pull/69))
...
- **Privacy by default, not by force.** If you use the local Piper, Whisper, or persona backends, audio, transcripts, and documents stay on your machine. The endpoint your app talks to is `localhost`. Switch a router to Deepgram, Azure, or another cloud vendor and that vendor sees the audio or text again, same as through any other client. The servers do not hide that trade-off. They let you make it per request instead of per app.
